<?php
   ...
   try {
        ...
        $duration_id = 1; // TODO: link to weekly, monthly? $_POST["duration"]
        $repeat_interval = $_POST["repeat_interval"];;
        $repeat_on_monday = $_POST["repeat_on_monday"] ? 1 : 0;
        $repeat_on_tuesday = $_POST["repeat_on_tuesday"] ? 1 : 0;
        $repeat_on_wednesday = $_POST["repeat_on_wednesday"] ? 1 : 0; 
        $repeat_on_thursday = $_POST["repeat_on_thursday"] ? 1 : 0;
        $repeat_on_friday = $_POST["repeat_on_friday"] ? 1 : 0;
        $repeat_on_saturday = $_POST["repeat_on_saturday"] ? 1 : 0;
        $repeat_on_sunday = $_POST["repeat_on_sunday"] ? 1 : 0;
